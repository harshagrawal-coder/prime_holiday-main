  ...
  return (
    <div className="w-full min-w-0 p-4 sm:p-6">
      <div className="mb-6 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
          <h1 className="text-2xl font-bold text-slate-800">Blog Categories</h1>
                    ...
                    <td className="px-4 py-3 text-right">
                      <div className="flex items-center justify-end gap-1">
                        <div className="group relative">
                          <button onClick={() => openModal(item)} aria-label="Edit category" className="flex h-9 w-9 items-center justify-center rounded-lg text-slate-400 transition hover:bg-orange-50 hover:text-orange-500">
                            <FaEdit size={16} />
                          </button>
                          <span className="pointer-events-none absolute bottom-full left-1/2 z-20 mb-2 -translate-x-1/2 whitespace-nowrap rounded-md bg-slate-900 px-2 py-1 text-xs text-white opacity-0 shadow-lg transition-opacity group-hover:opacity-100">Edit category</span>
                        </div>
                        <div className="group relative">
                          <button onClick={() => toggleStatus(item._id, item.isActive)} aria-label={item.isActive ? "Deactivate category" : "Activate category"} className={`flex h-9 w-9 items-center justify-center rounded-lg transition ${item.isActive ? "text-green-500 hover:bg-green-50 hover:text-green-600" : "text-slate-400 hover:bg-slate-100 hover:text-slate-600"}`}>
                        ...
                        <div className="group relative">
                          <button onClick={() => handleDelete(item._id)} aria-label="Delete category" className="flex h-9 w-9 items-center justify-center rounded-lg text-slate-400 transition hover:bg-red-50 hover:text-red-500">
                            <FaTrash size={16} />
                          </button>
                          <span className="pointer-events-none absolute bottom-full right-0 z-20 mb-2 whitespace-nowrap rounded-md bg-slate-900 px-2 py-1 text-xs text-white opacity-0 shadow-lg transition-opacity group-hover:opacity-100">Delete category</span>
                        </div>
                      </div>
                    </td>
                  </tr>
