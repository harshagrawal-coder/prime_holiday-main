            ...
            {items.map((item) => (
              <div key={item._id} className="rounded-xl border border-slate-200 bg-white p-4">
                ...
                <div className="mt-2 flex flex-wrap gap-2">
                  <span className="rounded-full bg-indigo-100 px-2.5 py-1 text-[11px] font-medium text-indigo-600">
                    {item?.stateId?.name || "No state"}
                  </span>
                  <span className="rounded-full bg-slate-100 px-2.5 py-1 text-[11px] font-medium text-slate-500">
                    {item?.stateId?.regionId?.name || "No region"}
                  </span>
                </div>
              ...
              <tbody className="divide-y divide-slate-100">
                {items.map((item) => (
                  <tr key={item._id} className="hover:bg-slate-50">
                    ...
                    <td className="px-4 py-3">
                      <span className="rounded-full bg-indigo-100 px-2.5 py-1 text-xs font-medium text-indigo-600">{item?.stateId?.name}</span>
                    </td>
                    <td className="px-4 py-3">
                      <span className="rounded-full bg-slate-100 px-2.5 py-1 text-xs font-medium text-slate-500">{item?.stateId?.regionId?.name}</span>
                    </td>
                    <td className="px-4 py-3">
