...
const initialBookings = [
  ...
  {
    id: "PH-8100",
    tour: "Rishikesh Adventure Weekend",
    date: "15 Jan 2026",
    price: "₹12,000",
    status: "Cancelled",
    guests: 2,
    ...
    <div className="space-y-12 animate-fade-in">
      ...
      <div className="space-y-4">
        {bookings.map((b) => (
          <div
            key={b.id}
            className="group overflow-hidden rounded-2xl border border-slate-100 bg-white shadow-[0_4px_20px_rgb(0,0,0,0.04)] transition-all duration-300 hover:-translate-y-1 hover:shadow-lg hover:border-orange-200 flex flex-col md:flex-row"
          >
            <div className="p-4 md:p-5 flex-1">
              <div className="mb-2 flex items-center justify-between md:justify-start gap-3">
                ...
                <span
                  className={`rounded-full px-2.5 py-0.5 text-[10px] font-black uppercase tracking-widest ${statusStyles[b.status]}`}
                >
                  {b.status}
                </span>
              </div>
